...
export class CompanyController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'La compañía ha sido creada exitosamente.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Detalles de la compañía.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Compañía no encontrada.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
  ...
  @ApiParam({ name: 'name', required: true, description: 'Nombre de la compañía' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Detalles de la compañía.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Compañía no encontrada.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'La compañía ha sido actualizada exitosamente.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Compañía no encontrada.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Datos de entrada inválidos.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Aplicaciones asignadas exitosamente a las compañías.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Datos de entrada inválidos.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
  ...
  @ApiParam({ name: 'id', required: true, description: 'UUID de la compañía' })
  @ApiResponse({ status: HttpStatus.OK, description: 'La compañía ha sido eliminada exitosamente.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Compañía no encontrada.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
