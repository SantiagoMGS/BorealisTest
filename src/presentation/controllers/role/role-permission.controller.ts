...
export class RolePermissionController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Los permisos han sido asignados exitosamente al rol.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Lista de permisos para el rol especificado.' })
  ...
  @ApiResponse({ status: HttpStatus.NO_CONTENT, description: 'El permiso ha sido eliminado exitosamente del rol.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Rol o permiso no encontrado.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Resultado de la verificación del permiso.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Datos de entrada inválidos.' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado.' })
  @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Recurso prohibido.' })
